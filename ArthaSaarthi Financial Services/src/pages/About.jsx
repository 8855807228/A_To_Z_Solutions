            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div className="rounded-2xl bg-primary/5 p-8">
                ...
                <p className="mt-4 text-sm leading-6 text-gray-600">
                  To empower individuals with financial knowledge and guide them
                  towards achieving their life goals through smart financial
                  planning. We believe in building long-term relationships based
