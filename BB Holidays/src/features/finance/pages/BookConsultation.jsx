...
export default function BookConsultation() {
  const { consultationPreferences, setConsultationPreferences } = useFinance();
  ...
  const formik = useFormik({
    initialValues: {
      ...
      phone: '',
      preferredDate: null,
      preferredTime: consultationPreferences.preferredTime,
      consultationType: consultationPreferences.preferredMode,
      message: '',
    },
    validationSchema,
    onSubmit: async (values) => {
      try {
        // Save preferences for future consultations
        setConsultationPreferences({
          preferredMode: values.consultationType,
